...
public class TipsManager : MonoBehaviour
{
	...
	public void showTips_400m()
	{
		...
		bodyText1.text = "";
		controlsButtonL.gameObject.SetActive(value: false);
		controlsButtonR.gameObject.SetActive(value: false);
	...
	public void show()
	{
		TipsWindow.SetActive(value: true);
		isShowing = true;
	}

	public void hide()
	{
		TipsWindow.SetActive(value: false);
		isShowing = false;
	}
